...
from src.inference import (
    ...
    load_model_from_registry, #codigo del video
    get_model_predictions, #codigo del video
...
with st.spinner(text="Computing model predictions"):
    results = get_model_predictions(model, features_df)
    st.sidebar.write('✅ Model predictions arrived')
